    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('szContentText', ckeditor.fields.RichTextField(blank=True, default='', help_text='Содержание <b>БЕЗ АНОНСА</b> <small>(допустим HTML-код, будет обработан типографом, если его включить)</small>', verbose_name='Содержание')),
                ('szContentSlug', models.SlugField(help_text='Слаг  (транслитерация) контента', max_length=255, unique=True, verbose_name='slud')),
                ...
                ('kImages', models.ManyToManyField(blank=True, help_text='Картинка привязанная к контенту (к одной единице контента может быть привязано несколько картинок)', null=True, to='web.tbimage', verbose_name='Картинка')),
